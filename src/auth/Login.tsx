...
const SignIn: React.FC = () => {
  const { user, handleLoginWithGoogle, handleLoginWithEmail } = useUser();
  ...
  useEffect(() => {
    ...
    const storedPasswordError = localStorage.getItem("passwordError");
    const storedError = localStorage.getItem("error");

    if (storedEmailError) setEmailError(storedEmailError);
    if (storedPasswordError) setPasswordError(storedPasswordError);
          ...
          <div className="full-screen flex items-center justify-center">
            <div className="relative flex flex-col flex-nowrap items-center justify-center w-popup-width min-h-popup-minimum max-h-popup-height overflow-hidden shadow-lg rounded-xl">
              <div className="rounded-20 bg-sui-lightest shadow-wallet-content flex flex-col items-center px-7 py-6 h-full overflow-auto">
                ...
                <div className="w-[300px] mt-6 p-2 mb-3">
                  <form onSubmit={handleLogin}>
                    ...
                    <input
                      ...
                      } rounded w-full py-2 p-2 mb-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline`}
                      id="email"
                      type="email"
                      placeholder="Email"
                      value={email}
                    ...
                    <input
                      ...
                      } rounded w-full py-2 p-2 m text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline`}
                      id="password"
                      type="password"
                    ...
                    <button className="w-full p-2 bg-blue-500 text-white rounded mb-3">
                      Login
                    </button>
                    {errors && (
                      <p className="text-red-500 text-xs italic mt-2">
                  ...
                  <button
                    ...
                    key="Google"
                    className="h-10 w-full rounded-xl items-center justify-center gap-3 px-4 py-2 disabled:opacity-40 focus:opacity-80 bg-white text-steel-dark border border-solid border-steel hover:border-steel-dark hidden"
